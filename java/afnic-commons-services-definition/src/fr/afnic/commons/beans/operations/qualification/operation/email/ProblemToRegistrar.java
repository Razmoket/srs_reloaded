...
public class ProblemToRegistrar extends QualificationEmailTemplate {

    public ProblemToRegistrar(UserId userId, TldServiceFacade tld) {
        super(OperationType.NotifyEmailProblemToRegistrar,
              QualificationEmailTemplateDestinary.Registrar, userId, tld);
    }

    @Override
    protected String buildEndSubject() throws ServiceException {
        return "AFNIC - Qualification " + this.getHolderNicHandle() + " - Gel de portefeuille de domaines";
    }
