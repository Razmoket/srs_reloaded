...
public class ContractTypeTableRecordToContractOffre extends AbstractConverter<ContractTableRecord, Contract> {

    public ContractTypeTableRecordToContractOffre() {
