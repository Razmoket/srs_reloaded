...
public class ReminderAutoMailReachabilityToHolder extends ValorizationEmailTemplate {

    public ReminderAutoMailReachabilityToHolder(UserId userId, TldServiceFacade tld) {
        super(OperationType.NotifyReminderAutoMailReachabilityToHolder,
    ...
    protected String buildEndSubject() throws ServiceException {
        return "IMPORTANT-RAPPEL/REMINDER : Votre nom de domaine " + this.getDomainName() + " / Your domain name " + this.getDomainName();
    }
    ...
    protected String buildFrContent() throws ServiceException {
        ...
        return new StringBuilder().append("[English version below]" + this.getSeparator())
                                  ...
                                  .append("Cher titulaire du nom de domaine <a href=\"http://" + this.getDomainName() + "\">" + this.getDomainName() + "</a>,"
                                          + this.getSeparator())
                                  .append(this.getSeparator())
                                  .append(this.getSeparator())
                                  .append("Sauf erreur de notre part, vous n'avez pas donné suite au message que nous vous avons adressé il y a 7 jours." + this.getSeparator())
                                  ...
                                  .append("La fiabilité de cette donnée est essentielle pour pouvoir vous contacter en cas de problème ou pour certaines opérations sur votre nom de domaine. Maintenir des données exactes est également une obligation légale. Plus de détails sont disponibles dans la <a href=\"http://www.afnic.fr/fr/ressources/documents-de-reference/chartes/charte-de-nommage-applicable-a-partir-du-6-decembre-2011-6.html\">charte de nommage AFNIC<a>."
                                                  + this.getSeparator())
                                  .append(this.getSeparator())
                                  .append("Pour répondre à  notre vérification et ainsi confirmer que l'adresse courriel associée à  votre nom de domaine est valide, il vous suffit de cliquer sur le lien ci-dessous :"
                                                  + this.getSeparator())
                                  .append(this.getSeparator())
                                  .append("<a href=\"" + urlFr + "\">")
                                  .append(urlFr + "</a>"
                                          + this.getSeparator())
                                  .append(this.getSeparator())
                                  .append("Nous vous invitons à  effectuer la démarche de validation de votre adresse courriel dès à  présent, le lien à  cliquer ayant désormais une durée de validité de 7 jours."
                                                  + this.getSeparator())
                                  .append(this.getSeparator())
                                  .append(this.getSeparator())
                                  ...
                                  .append("L'AFNIC (Association Française pour le Nommage Internet en Coopération) est l'organisme désigné par l'état français pour la gestion des noms de domaine sous les extensions géographiques françaises suivantes : .fr, .re, .pm, .yt, .tf et .wf. Cette délégation est formalisée par une convention consultable à  l'adresse suivante : <a href=\"http://www.afnic.fr/fr/ressources/documents-de-reference/cadre-legal/\">http://www.afnic.fr/fr/ressources/documents-de-reference/cadre-legal/</a>"
                                                  + this.getSeparator())
                                  .append(this.getSeparator())
                                  .append("C'est auprès de l'AFNIC que votre bureau d'enregistrement ou le prestataire qui gère votre site web a enregistré le nom de domaine <a href=\"http://"
                                          + this.getDomainName() + "\">"
                                  ...
                                  .append("-   sur le cadre légal applicable à  l'enregistrement des noms de domaine sous les extensions gérées par l'AFNIC : <a href=\"http://www.afnic.fr/fr/ressources/documents-de-reference/cadre-legal/\">http://www.afnic.fr/fr/ressources/documents-de-reference/cadre-legal/</a>"
                                                  + this.getSeparator())
                                  .append(this.getSeparator())
                                  .append("Vous souhaitez nous contacter pour vérifier la provenance du présent courriel : notre support est joignable au +33 1 39 30 83 00 ou par courriel à  <a href=\"mailto:support@afnic.fr\">support@afnic.fr</a>."
                                                  + this.getSeparator())
                                  ...
                                  .append(this.getSeparator())
                                  .append("<a href=\"mailto:support@afnic.fr\">support@afnic.fr</a>" + this.getSeparator())
    ...
    protected String buildEnContent() throws ServiceException {
        ...
        return new StringBuilder().append("Dear holder of <a href=\"http://" + this.getDomainName() + "\">" + this.getDomainName() + "</a>," + this.getSeparator())
                                  .append(this.getSeparator())
                                  .append("Errors or omissions excepted, it seems you have not done any follow-up on the email we sent you 7 days ago." + this.getSeparator())
                                  ...
                                  .append(this.getSeparator())
                                  .append("We advise that you do it as soon as possible, as the link only remains valid for 7 days." + this.getSeparator())
                                  .append(this.getSeparator())
                                  .append(this.getSeparator())
                                  ...
                                  .append("Details about AFNIC's legal framework : <a href=\"http://www.afnic.fr/en/ressources/reference/legal-framework/\">http://www.afnic.fr/en/ressources/reference/legal-framework/</a>"
                                                  + this.getSeparator())
                                  .append(this.getSeparator())
                                  .append("Your registrar or your web site provider has registered <a href=\"http://" + this.getDomainName() + "\">"
                                          + this.getDomainName() + "</a> with AFNIC." + this.getSeparator())
                                  .append("To learn more about AFNIC : <a href=\"www.afnic.fr\">www.afnic.fr</a>" + this.getSeparator())
                                  .append(this.getSeparator())
                                  .append("If you wish to verify that we are the actual sender of the present email, you can contact our customer support by phone at +33 1 39 30 83 00 or by email to <a href=\"mailto:support@afnic.fr\">support@afnic.fr</a>."
                                                  + this.getSeparator())
